...
{
    protected $signature = 'apsis:moduleMaker{module}';
        ...
        if ($this->confirm('Is ' . $moduleName . ' correct, do you wish to continue? [y|N]')) {
            ...
            foreach ($fields as $key => $field) {
                if(!in_array($field->Field,['created_by','created_at','updated_by','updated_at']) && $field->Key != 'PRI') {
                    ...
                    $masterEntryDetail['table_name'] = $moduleName . "s";
            ...
            $master_form_button['table_name'] = $moduleName . "s";
            $master_form_button['field_name'] = $moduleName . "s_id";
...
//            dd($masterEntryDetails);
            ...
            $grid_sql = "SELECT * FROM $moduleName" . 's';
            $master_grid['grid_title'] = ucfirst(str_replace('_', ' ', $moduleName));
            $master_grid['grid_sql'] = $grid_sql;
            $master_grid['primary_key_field'] = $moduleName . 's_id';
            $master_grid['action_table'] = $moduleName . 's';
