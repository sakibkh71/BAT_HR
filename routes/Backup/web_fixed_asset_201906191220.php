...
Route::get('fams/add-asset/{id?}/{tab?}', 'FixedAsset\FixedAssetController@addAsset')->name('add-asset');
...
Route::get('fams/asset-list', 'FixedAsset\FixedAssetController@get_asset_list')->name('asset_list');
