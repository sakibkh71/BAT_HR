        ...
        <div class="row">
            <div class="col-md-12 no-padding">
                ...
                <div class="ibox-content">
                    {!! __getMasterGrid('hr_company_pf_policy',1) !!}
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        (function ($) {
            ...
            $("#grade_edit").on('click', function (e) {
                var company_pf_policy_id = selected[0];

                if (company_pf_policy_id.length === 0) {
                    swalError("Please select a Grade");
                    return false;
                } else {
             window.location = '<?php echo URL::to('company-pf-policy-edit');?>/' + company_pf_policy_id;
                }
            });
