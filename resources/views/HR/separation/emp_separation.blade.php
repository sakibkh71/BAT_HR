        ...
        <div class="row">
            <div class="col-md-12 no-padding">
                ...
                <div class="ibox-content">
                    <form action="{{url('get-separation-form')}}" method="post">
                        <div class="col-md-12 row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="font-normal"><strong>Termination Date</strong> <span class="required">*</span></label>
                                    <div class="">
                                        <input type="text" placeholder="YYYY-MM-DD" value="{{$date_from}}" name="date_from" class="form-control" id="month_from">
                                    </div>
                                    <div class="help-block with-errors has-feedback"></div>
                                </div>
                            </div>
