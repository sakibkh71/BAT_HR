            ...
            <div class="col-lg-12 no-padding">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form action="{{route('daily-duty-report')}}" method="post" id="shiftFilterForm" class="mb-4">
                            @csrf
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control" name="is_rotable" id="is_rotable">
                                        <option value="0" {{isset($is_rotable) && $is_rotable == '0'?'selected':''}}>Daily Shedule</option>
                                        <option value="1" {{isset($is_rotable) && $is_rotable == '1'?'selected':''}}>Roster schedule</option>
                                    </select>
                                </div>
