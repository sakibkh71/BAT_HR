                    ...
                    <div class="ibox-title">
                        <div class="ibox-tools">
                            @if(isSuperUser())
                                ...
                                <button class="btn btn-warning btn-xs no-display" id="item_edit"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</button>
                                <button class="btn btn-primary btn-xs no-display" id="item_view"><i class="fa fa-eye" aria-hidden="true"></i> View</button>
                            @endif
                        </div>
                    </div>
...
$(document).on('click','#item_view', function (e) {
    ...
    var url = '<?php echo URL::to('user-info');?>';
    Ladda.bind(this);
    var load = $(this).ladda();
    if (selected_item.length == 1) {
