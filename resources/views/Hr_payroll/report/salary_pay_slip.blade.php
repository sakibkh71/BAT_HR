    ...
    <tbody>
        ...
        <td width="100%" valign="top"  style="border-left: none">
            <table class="table-bordereds">
                <tr>
                    <td>{{__lang('Salary')}}</td>
                    <td align="right" class="border"><strong>{{ !empty($total_addition)?number_format($total_addition, 2): '0'}}</strong></td>
                </tr>
                <tr>
                    <td>{{__lang('Arrear')}}</td>
                ...
                <tr>
                    <td>Total</td>
                    @php($totalEarning = $total_addition + $row->arrear + $row->attendance_bonus)
        ...
        <tr>
            <td width="100%" valign="top"  style="border-left: none">
                <table class="table-bordered">
                    ...
                    <tr>
                        <td>{{__lang('Net Amount (in BDT)')}}</td>
