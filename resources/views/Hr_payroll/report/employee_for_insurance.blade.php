...
@section('content')
            ...
            <div class="col-md-12 no-padding">
                <div class="ibox">
                    <div class="ibox-title">
                        <h2>{{  implode(", ",  $posted['status']) }}  Employee list for insurance</h2>
                        <div class="ibox-tools"></div>
                    </div>
                    <div class="ibox-content">
                        <form action="{{route('employee-insurance')}}" method="post" id="employeeListForm" class="mb-4">
                            @csrf
    ...
    <script>
        ...
        $('#exportExcel').click(function () {
            ...
            var url='{{route("employee-insurance",['type'=>'excel'])}}';
            $.ajax({
               type:'get',
               url:url,
               data:data,
