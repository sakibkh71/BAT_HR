...
@section('content')
    ...
    <div class="wrapper wrapper-content">
        <div class="ibox ">
            <div class="ibox-title">
                <h2>Company Calender </h2>
                <div class="ibox-tools">
                    @if(isset($bat_company))
                    {{--<a href="#" id="viewCalendar" class="btn btn-primary btn-xs">View Company Calender</a>--}}
                    @endif
                </div>
            </div>
            <div class="ibox-content">
                <div class="row">
                    <div class="col-lg-3">
                        ...
                        <form id="calendar_config_form" class="" method="post" action="{{route('company-calendar-config')}}">
                            {{csrf_field()}}
                            ...
                            <div class="form-group mt-3">
                                <button id="show_company_calender" type="submit" class="btn btn-primary" style="width: 100%">Calendar
                                    Configuration
                                </button>
                            </div>
                        </form>
                        ...
                        <div id="event_area">
                            ...
                            <div class="external-event bg-success ui-draggable ui-draggable-handle">Working Day</div>
    ...
    <script>
        ...
        $('#viewCalendar').click(function (e) {
            e.preventDefault();
            var empcat =$("select[name='bat_company_id']").val();
            var clmonth =$("input[name='calendar_month']").val();

           $('<form action="{{route('company-calendar-show')}}" method="post"> @csrf <input type="hidden" name="bat_company_id" value="'+ empcat +'"><input type="hidden" name="calendar_month" value="'+ clmonth +'"></form>').appendTo('body').submit();
        })
    </script>
