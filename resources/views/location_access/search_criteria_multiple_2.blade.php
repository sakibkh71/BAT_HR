<div class="row btn_tree_div">
    <div class="col-md-12">
        <div class="form-group">
            <h4>Location Tree</h4>
            <span><button id="btn_region" data-toggle="tooltip" class="btn btn-sm next btn-success" title="Click to Choose Region" data-type="region">Region</button></span> &nbsp;&nbsp;
            <span><button id="btn_area" data-toggle="tooltip" class="btn btn-sm next" title="Click to Choose Area" data-type="area">Area</button></span> &nbsp;&nbsp;
            <span><button id="btn_house" data-toggle="tooltip" class="btn btn-sm next" title="Click to Choose House" data-type="house">House</button></span> &nbsp;&nbsp;
            <span><button id="btn_territory" data-toggle="tooltip" class="btn btn-sm next" title="Click to Choose Territory" data-type="territory">Territory</button></span> &nbsp;&nbsp;
            <span><button id="btn_point" data-toggle="tooltip" class="btn btn-sm next" title="Click to Choose Point" data-type="point">Point</button></span> &nbsp;&nbsp;
        </div>
    </div>
</div>

<div class="row">
    <div class="col-md-4" id="region_div" style="">
    ...
    <div class=" col-md-4" id="area_div" style="">        
    ...
    <div class=" col-md-4" id="territory_div" style="margin-right: 30px">
        @php if(isset($territory) && count($territory) > 0) { @endphp
        <label for="territory" class="form-label">Territory</label>
        <select name="territory[]" id="territory" class="form-control multi" multiple="multiple">
    ...
    <div class="form-group col-md-4" id="point_div" style="margin-right: 30px">
    @php if(isset($points) && count($points) > 0) { @endphp
        <label for="point" class="form-label">Distribution Point</label>
        <select name="point[]" id="point" class="form-control multi" multiple="multiple">
