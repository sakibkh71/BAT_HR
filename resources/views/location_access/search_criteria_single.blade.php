...
<div class="row">    
    <div class="form-group col-sm-2" id="region_div" style="margin-right: 30px">
        ...
        <select name="selRegion[]" id="region" class="form-control">            
    ...
    <div class="form-group col-sm-2" id="area_div" style="margin-right: 30px">        
    ...
    <div class="form-group col-sm-2" id="house_div" style="margin-right: 30px">
        @php if(isset($companies) && count($companies) > 0) { @endphp
        <label for="house">Distribution House</label>
        <select name="house[]" id="house" class="form-control col-sm-2">
    ...
    <div class="form-group col-sm-2" id="territory_div" style="margin-right: 30px">
        @php if(isset($territory) && count($territory) > 0) { @endphp
        <label for="territory">Territory</label>
        <select name="territory[]" id="territory" class="form-control col-sm-2">
    ...
    <div class="form-group col-sm-2" id="point_div" style="margin-right: 30px">
    @php if(isset($points) && count($points) > 0) { @endphp
        <label for="point">Distribution Point</label>
        <select name="point[]" id="point" class="form-control col-sm-2">
